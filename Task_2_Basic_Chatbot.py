...
def load_responses(basic_responses):
    responses = {}
    with open(basic_responses, 'r') as file:
...
basic_responses = load_responses('basic_responses.txt')

def Bot_basic_response(user_input):
    user_input = user_input.lower()
    
    for pattern, basic_response in basic_responses.items():                                    #this function will check for pattern matching and resposes by user and also covert in lower case the user input
